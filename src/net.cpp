...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Oximcoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"oximcointools.com", "oximcointools.com"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"oximcointools.com", "testnet-seed.oximcointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Oximcoin is probably already running."), addrBind.ToString().c_str());
        else
